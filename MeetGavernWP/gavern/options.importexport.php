...
?>
	<div class="gkWrap wrap">
			...
			<?php
				if (isset($_FILES['import']) && check_admin_referer('gavern_importexport')) {
					if ($_FILES['import']['error'] > 0) 
						echo "<div class='error'><p>".__('No file selected, please make sure to select a file.', GKTPLNAME)."</p></div>";		
					else {
		...
		?>
			<p><?php _e('1. Click &#147Browse&#148 button and choose a backup file that you backup before.', GKTPLNAME); ?></p>
			<p><?php _e('2. Click &#147Restore Template Settings&#148 button to restore your template settings.', GKTPLNAME); ?></p>
...
?>
		<div class="gkExport">
	        ...
	        <p><?php _e('When you click &#147Backup Template Settings&#148 button, system will generate a template backup file for you to save on your computer.', GKTPLNAME); ?></p>
